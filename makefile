...
mainTest.o: mainTest.cpp GameState.hpp Item.hpp Room.hpp Holodeck.hpp CommandCenter.hpp
	g++ $(CFLAGS) -c mainTest.cpp GameState.hpp Item.hpp Room.hpp Holodeck.hpp CommandCenter.hpp
